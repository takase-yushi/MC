...
double getPredictedImage(unsigned char **expand_ref, cv::Mat& target_image, cv::Mat& output_image, Point4Vec& square, std::vector<cv::Point2f>& mv, unsigned char *ref_hevc = nullptr);
